...
# data_path = "test collection/"   # define UCF-101 RGB data path
# action_name_path = 'test3.pkl'
# save_model_path = "save_model/"
...
if __name__ == '__main__':
    ...
    cnn_encoder.load_state_dict(torch.load(os.path.join(save_model_path, 'cnn_encoder_epoch15.pth')))
    rnn_decoder.load_state_dict(torch.load(os.path.join(save_model_path, 'rnn_decoder_epoch15.pth')))
    ...
    df.to_pickle("./Ginger_bread_25.pkl")  # save pandas dataframe
